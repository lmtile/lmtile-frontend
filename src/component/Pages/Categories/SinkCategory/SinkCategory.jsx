                ...
                <div className='p-3 bg-base-100 shadow-2xl shadow-black'>
                    <div className="hero-content flex-col lg:flex-row-reverse bg-base-300 ">
                        ...
                        <div>
                            ...
                            <Link to="/products/sink?type=Double%20Bowl%20Kitchen%20Sinks"><button className='btn btn-outline rounded-none'>Shop Double Bowl Kitchen Sinks</button></Link>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className='p-3 bg-base-100 shadow-2xl shadow-black'>
                    <div className="hero-content flex-col lg:flex-row bg-base-300 ">
                        ...
                        <div>
                            ...
                            <Link to="/products/sink?type=Single%20Bowl%20Kitchen%20Sinks"><button className='btn btn-outline rounded-none'>Shop Single Bowl Kitchen Sinks</button></Link>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className='p-3 bg-base-100 shadow-2xl shadow-black'>
                    <div className="hero-content flex-col lg:flex-row-reverse bg-base-300 ">
                        ...
                        <div>
                            ...
                            <Link to="/products/sink?type=Quartz%20Composite%20Sinks"><button className='btn btn-outline rounded-none'>Shop Quartz Composite Sinks</button></Link>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className='p-3 bg-base-100 shadow-2xl shadow-black'>
                    <div className="hero-content flex-col lg:flex-row-reverse bg-base-300 ">
                        ...
                        <div>
                            ...
                            <Link to="/products/sink?type=Vanity%20Sinks"><button className='btn btn-outline rounded-none'>SHOP Vanity Sink</button></Link>
                        </div>
                    </div>
                </div>
            </div>
