                ...
                <div className="collapse-content">
                    <div className='grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 '>
                        <div className='mt-10 ml-8'>
                            ...
                            <div>
                                <a href="https://www.roomvo.com/my/mellifluousraindrop34e39fnetlifyapp/rooms?visitor_id=888b218b66774ac0bfacec16bbed1a36&tracking_code=&locale=en-us&prefilter=%7B%22brands%22%3A%5B%5D%7D&is_dealer=1&iframe_id=ffPopup&originator=&use_host_navigation=1&vendor_code=&product_type=1&domain=mellifluous-raindrop-34e39f.netlify.app&is_in_top_window=0&use_history_padding=0"><button className='btn rounded-none bg-red-800 mt-10 lg:ml-20 md:ml-20 font-bold'>FIND A FLOOR<FaArrowAltCircleRight className='text-xl ml-3' /></button></a>
                            </div>
                        </div>
